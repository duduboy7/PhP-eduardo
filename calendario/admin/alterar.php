<?php 
	...
	try {
		...
		// Diminuir um dia para o calendário mostrar corretamente
		$fim = date('Y-m-d', strtotime('-1 days', strtotime($resultado->end)));
	} catch (Exception $e) {
		echo $e->getMessage();
	}
...
<h3 class="alert alert-info">
	<i class="fa-solid fa-pen"></i> Altera compromisso
</h3>
...
<form name="form1" id="form1" method="post">
	...
	<?php }else if($resultado->color == '#0F0') { ?>
		<div class="col">
			<label>Cor do compromisso</label><br>
			<label for="color1" class="mt-2 mr-3">
				<input type="radio" 
	...
	<div class="row">
		<div class="col">
			...
			<input type="date" name="start" id="start"
			       class="form-control"
			       value="<?php echo $resultado->start; ?>">
		</div>
		<div class="col">
	...
	<textarea name="description" id="description"
	          rows="8" class="form-control ckeditor"><?php echo $resultado->description; ?></textarea>
